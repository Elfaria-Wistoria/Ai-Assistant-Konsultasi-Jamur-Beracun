...
try:
    ...
    prompt = ChatPromptTemplate(
        messages=[
            ...
            "Pastikan jawaban MushMate selalu terasa seperti ngobrol seorang profesor yang ahli dalam hal jamur beracun"
),
    ...
    query = "Apa itu jamur beracun?"  # Ganti dengan pertanyaan yang diinginkan
